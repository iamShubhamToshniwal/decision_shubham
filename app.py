...
Original file is located at
    https://colab.research.google.com/drive/1BrAYmwjjrMEnvwWDQikkyJvLmKmOxwFp
"""
...
pickle_in = open("decision_shubham.pkl","rb")
model=pickle.load(pickle_in)
dataset= pd.read_csv('ClassificationDataset2.csv')
...
def main():
   ...
   """
    ...
    Glucose = st.number_input('Insert a Glucose')
    BP= st.number_input('Insert a BP')
    SkinThickness = st.number_input('Insert a SkinThickness')
    Insulin = st.number_input('Insert aInsulin')
